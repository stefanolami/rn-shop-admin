...
export default function HomePage() {
	...
	return (
		<div className="min-h-screen relative">
			<div className="absolute w-full opacity-40 h-full bg-gradient-to-b from-black to-indigo-400"></div>
			<header className="container z-10 relative mx-auto px-4 py-6 flex justify-between items-center">
				<h1 className="text-2xl font-bold">Gadget App</h1>
				<Link href="/auth">
					<Button>Login</Button>
				</Link>
			</header>
			<main className="container px-4 py-12 mx-auto z-10 relative">
						...
						<div className="md:w-1/2 mb-8 md:mb-0">
							...
							<MotionWrapper delay={0.2}>
								<p className="text-xl mb-6">
									Shop the latest tech right from your pocket
									with our innovative mobile app
								</p>
							</MotionWrapper>
						...
						<div className="w-1/3">
							<MotionWrapper delay={0.4}>
								...
								>
									...
									/>
									<Badge className="absolute top-4 right-4 bg-[#1bc464] text-white hover:text-[#1bc464] cursor-default">
										New Release
									</Badge>
								</motion.div>
							</MotionWrapper>
